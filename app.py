...
def welcome():
    ...
    return (
        ...
        f"NB: API calculates stats through 8/23/2017 should no end-date be provided.<br>" 
    )
...
def trip2(start_date, end_date='2017-08-23'):
    ...
    if trip_dict['Min']: 
        ...
        return jsonify({"error": f"Date(s) not found, invalid date range or dates formatted incorrectly."}), 404
